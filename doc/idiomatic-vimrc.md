...
Use non-recursive mappings if you intend to ONLY use default commands in your
...
Historically, the normal method for installing plugins was to put each file in
